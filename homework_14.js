...
const length = parseInt(prompt("Task 1: Введіть довжину масиву:"));
const inputArray = [];

if (!isNaN(length) && length > 0) {
    for (let i = 0; i < length; i++) {
        const userInput = parseFloat(prompt(`Task 1: Введіть значення для елемента ${i + 1}:`));
        if (!isNaN(userInput)) {
            inputArray.push(userInput);
        } else {
            console.log(`Task 1: Неправильне значення для елемента ${i + 1}.`);
            i--;
        }
    }
...
function doMath(x, znak, y) {
    ...
    if (isNaN(x) || isNaN(y)) {
        console.log("Task 2: Введіть коректні числа.");
        return;
    }
...
const x = prompt("Task 2: Введіть перше число:");
const znak = prompt("Task 2: Введіть операцію (+, -, *, /, %, ^):");
const y = prompt("Task 2: Введіть друге число:");
...
function fill2DArray() {
    const numRows = +prompt("Task 3: Введіть кількість рядків:");
    const numCols = +prompt("Task 3: Введіть кількість стовпців:");
...
const inputString = prompt("Task 4: Введіть два слова через пробіл:");
if (!inputString) {
...
//         switch (taskNumber) {
//             case 1:
//                 taskDescription = "Task 14.1: Дано масив з елементами різних типів. Створити функцію...";
...
//                 break;
//             case 2:
//                 taskDescription = "Task 14.2: Написати функцію doMath(x, znak, y), яка отримує 3 аргументи...";
//                 console.log(taskDescription);
...
//                 break;
//             case 3:
//                 taskDescription = "Task 14.3: Написати функцію заповнення даними користувача двомірного масиву...";
//                 console.log(taskDescription);
...
//                 break;
//             case 4:
//                 taskDescription = "Task 14.4: Створити функцію, яка прибирає з рядка всі символи...";
//                 console.log(taskDescription);
...
//
//                         const charsToRemove = prompt("Введіть символи для видалення (через запятую або пробіл):").split(/[,\s]+/);
//                         const result = [firstWord, secondWord].map(async word => await removeChars(word, charsToRemove)).join(' ');
//
//                         console.log("Оригінальні слова:", firstWord, secondWord);
//                         console.log("Результат:", result);
//                     }
