...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Обработчик события для отображения корзины при нажатии на кнопку "Cart".
    cartButton.addEventListener('click', () => {
        // Скрываем другие разделы и отображаем корзину.
    ...
    // Обработчик события для отображения формы заказа при нажатии на кнопку "Buy".
    buyButton.addEventListener('click', () => {
        // Скрываем корзину и отображаем форму заказа.
        cartSection.classList.add('hidden');
        orderForm.classList.remove('hidden');
    });

    // Обработчик события для отправки заказа при нажатии кнопки "Submit Order".
    document.getElementById('submit-button').addEventListener('click', () => {
        ...
        // Заполнение данных о заказе в соответствующих элементах.
        ...
        // Скрываем форму заказа и отображаем детали заказа.
        orderForm.classList.add('hidden');
